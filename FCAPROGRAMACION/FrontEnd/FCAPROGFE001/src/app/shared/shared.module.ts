...
// Programacion
import { ListaMaquinaComponent } from './components/Programacion/lista-maquina/lista-maquina.component';
import { ListaProcesocostoComponent } from './components/Programacion/lista-procesocosto/lista-procesocosto.component';
import { MdlBuscarpapelComponent } from './components/Programacion/mdl-buscarpapel/mdl-buscarpapel.component';
import { ListaTipomaquinaComponent } from './components/Programacion/lista-tipomaquina/lista-tipomaquina.component';
import { ListaDesperdicioComponent } from './components/Produccion/lista-desperdicio/lista-desperdicio.component';
import { ListaCargoareacapComponent } from './components/Produccion/lista-cargoareacap/lista-cargoareacap.component';
import {ListaCodVariacionComponent} from './components/Programacion/lista-variacion/lista-codvariacion.component';
...
import { ListaClavepreparacionComponent } from './components/Programacion/lista-clavepreparacion/lista-clavepreparacion.component';
import { ProgListaAlmacenComponent } from './components/Programacion/lista-almacen/lista-almacen.component';
...
@NgModule({
  declarations: [
    ...
    ListaProcesocostoComponent,
    MdlBuscarpapelComponent,
    ListaTipomaquinaComponent,
    ListaDesperdicioComponent,
    ListaCargoareacapComponent,
    ListaCodVariacionComponent,
    PopupCellRendererComponent,
    LabelcolCellRenderComponent,
    ListaClavepreparacionComponent,
    ProgListaAlmacenComponent
  ],
  imports: [
        CommonModule,
        FormsModule,
