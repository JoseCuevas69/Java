...
} from '../../../../models/Programacion/progauto/FCAPROG013MWModel';
import { FCAPROG013MWService } from '../../../../services/Programacion/progauto/fcaprog013-mw.service';

@Component({
  selector: 'app-fcaprog013-mw',
  templateUrl: './fcaprog013-mw.component.html',
  styleUrls: ['./fcaprog013-mw.component.css']
})
export class FCAPROG013MWComponent implements OnInit {
  ...
  constructor(
    ...
    public Servicio: FCAPROG013MWService
  ) {
