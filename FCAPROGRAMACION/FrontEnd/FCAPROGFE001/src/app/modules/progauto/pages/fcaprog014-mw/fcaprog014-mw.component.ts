...
import { FCAPROG014MWService } from '../../../../services/Programacion/progauto/fcaprog014-mw.service';
...
@Component({
  selector: 'app-fcaprog014-mw',
  templateUrl: './fcaprog014-mw.component.html',
  styleUrls: ['./fcaprog014-mw.component.css']
})
export class FCAPROG014MWComponent implements OnInit {
  ...
  constructor(
    ...
    public Servicio: FCAPROG014MWService
  ) { }
  ...
  limpiarCaptura(): void {
    this.objDatosCaptura.codigo = 0;
    this.objDatosCaptura.descripcion = '';
    this.objDatosCaptura.cantidad = 0;
    this.valueSelected = 0;
    this.descripcionSelected = '';
    this.cantidadSelected = 0;
  }
