...
import { FCAPROG016MWService } from '../../../../services/Programacion/progauto/fcaprog016-mw.service';
import { GridModel } from '../../../../models/common/gridModel';
import {
  CPLCAP009Entity, listaDatos, listaDatosPrincipal, resCambiosArticulos, resValidaVariacion
...
@Component({
  selector: 'app-fcaprog016-mw',
  templateUrl: './fcaprog016-mw.component.html',
  styleUrls: ['./fcaprog016-mw.component.css']
})
export class FCAPROG016MWComponent implements OnInit {
  ...
  constructor(
    ...
    public Servicio: FCAPROG016MWService
  ) {
    this.columnasGrid = [
      // Prio
      {
