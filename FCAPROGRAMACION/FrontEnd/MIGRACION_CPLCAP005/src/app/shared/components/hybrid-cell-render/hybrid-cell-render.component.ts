...
export class HybridCellRenderComponent implements ICellRendererAngularComp {
  ...
  refresh(): boolean {
    return this.type === 'txt' || this.type === 'num';
  }
  ...
  agInit(params: ICellRendererParams | any): void {
    ...
    if (typeof params.params === 'function') {
      ...
      pars.options = params.params.options ? Array.isArray(params.params.options) ? params.params.options : params.params.options() : [];
      pars.change = params.params.change;
      pars.disabled = params.params.disabled;
    } else {
      ...
      pars.options = params.options ? Array.isArray(params.options) ? params.options : params.options() : [];
      pars.change = params.change;
      pars.disabled = params.disabled;
    }
