...
namespace FCAPROGAPI002.Controllers
{
    ...
    [Route("/[controller]")]
    [ApiController]
    public class FCAPROG013MWController : Controller
    {
        private readonly TokenData datosToken = new TokenData();

        public FCAPROG013MWController(IOptions<AppSettings> AppSettings, IHttpContextAccessor httpContext)
        {
        ...
        public async Task<IActionResult> getDatosPrincipal(string clave = "")
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().getDatosPrincipal(datosToken, clave));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> getNextClaveProceso()
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().getNextClaveProceso(datosToken));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
        ...
        public async Task<IActionResult> getExistePapel(string clavePapel)
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().getExistePapel(datosToken, clavePapel));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
        ...
        public async Task<IActionResult> getExistenciaPapel(string clavePapel, string anchoPapel)
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().getExistenciaPapel(datosToken, clavePapel, anchoPapel));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
        ...
        public async Task<IActionResult> getRollosTransito(string clavePapel, string anchoPapel)
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().getRollosTransito(datosToken, clavePapel, anchoPapel));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
        ...
        public async Task<IActionResult> getPapelesDefaultCotizacion()
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().getPapelesDefaultCotizacion(datosToken));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
        ...
        public async Task<IActionResult> getCbxPreparacion()
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().getCbxPreparacion(datosToken));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
        ...
        public async Task<IActionResult> insertUpdateCplDat002(ListaCplCap002 Datos)
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().insertUpdateCplDat002(datosToken, Datos));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
        ...
        public async Task<IActionResult> updateCplDat002(ListaCplCap002 Datos)
        {
            try
            {
                return Ok(await new FCAPROG013MWBusiness().updateCplDat002(datosToken, Datos));
            }
            catch (Exception ex)
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Error, {ex.Message}");
